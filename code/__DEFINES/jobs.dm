...
#define DEPARTMENT_BITFLAG_PRISONER (1<<11)
#define DEPARTMENT_PRISONER "Inmate"
#define DEPARTMENT_BITFLAG_GUARD (1<<12)
#define DEPARTMENT_GUARD "Guard"
#define DEPARTMENT_BITFLAG_MAINT (1<<13)
#define DEPARTMENT_MAINT "Maintenance"
#define DEPARTMENT_BITFLAG_HEALTH (1<<14)
#define DEPARTMENT_HEALTH "Healthcare"
#define DEPARTMENT_BITFLAG_BUREAU (1<<15)
#define DEPARTMENT_BUREAU "Bureaucracy"
