/datum/job/dreams/warden
	title = JOB_PRISON_WARDEN
...
/datum/job/captain/get_captaincy_announcement(mob/living/captain)
	return "Warden [captain.real_name] on deck!"
...
/datum/outfit/job/dreams/warden
	name = "Prison Warden"
	jobtype = /datum/job/dreams/warden

	id = /obj/item/card/id/advanced/gold
	id_trim = /datum/id_trim/job/captain/warden
...
/datum/outfit/job/captain/pre_equip(mob/living/carbon/human/H, visualsOnly)
	. = ..()
	special_charter = CHECK_MAP_JOB_CHANGE(JOB_PRISON_WARDEN, "special_charter")
	if(!special_charter)
		return
